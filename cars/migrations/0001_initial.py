# Generated by Django 3.0.5 on 2021-06-06 13:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo_1', models.ImageField(blank=True, upload_to='images/%y/%m/%d/')),
                ('car_photo_2', models.ImageField(blank=True, upload_to='images/%y/%m/%d/')),
                ('car_photo_3', models.ImageField(blank=True, upload_to='images/%y/%m/%d/')),
                ('car_photo_4', models.ImageField(blank=True, upload_to='images/%y/%m/%d/')),
